...
class AgendarPaciente(CreateView): # VIEW PARA AGENDAR CONSULTA
    model=Paciente # TABELA DO BANCO DE DADOS

    fields=['nome', 'endereco', 'cpf', 'rg', 'telefone', 'email',
            'data_nascimento', 'prioridade', 'especialidade',
            'data_consulta', 'convenio_medico', 'forma_pagamento'] # CAMPOS DO FORMULARIO HTML
    
    template_name='gerenciador/agendar.html'# PASSAGEM DA TEMPLATE HTML

    def get_success_url(self): # REDIRECIONA PARA A PAGINA DE "CONSULTA MARCADA"
