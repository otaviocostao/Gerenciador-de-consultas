...
class Paciente(models.Model): # CLASSE QUE REPRESENTA A TABELA PACIENTE NA BASE DE DADOS
...
class PacienteFilaEspera(models.Model): # CLASSE QUE REPRESENTA A TABELA PacienteFilaEspera
    ...
    nome_fila = models.CharField(max_length=100,null=False, blank=False)

    endereco_fila = models.CharField(max_length=100)

    prioridade_fila = models.CharField(max_length=5, null=False, blank=False, choices=OPTION_CHOICES, default=OPTION_NAO)

    cpf_fila = models.CharField(max_length=15, null=False, blank=False)

    rg_fila = models.CharField(max_length=15)

    telefone_fila = models.CharField(max_length=20, null=False, blank=False)

    email_fila = models.CharField(max_length=100)

    data_nascimento_fila = models.DateField(null=False, blank=False)

    # Dados da consulta:

    especialidade_fila = models.CharField(max_length=50, null=False, blank=False, choices=ESPECIALIDADE_CHOICES, default=ESPECIALIDADE_UM)

    data_consulta_fila = models.CharField(max_length=50, null=False, blank=False, choices=DIAS_CHOICES)

    convenio_medico_fila = models.CharField(max_length=50, null=False, blank=False, choices=OPTION_CHOICES, default=OPTION_NAO)

    forma_pagamento_fila = models.CharField(max_length=50, null=False, blank=False, choices=PAGAMENTO_CHOICES, default=PAGAMENTO_UM)
